...
interface HoneyChainApiService {
    ...
    @GET("beekeeper/harvests/{harvest_id}/batches")
    suspend fun getBatchesForHarvest(@Path("harvest_id") harvestId: String): List<BatchDto>
    ...
    @POST("beekeeper/products/{product_id}/status")
